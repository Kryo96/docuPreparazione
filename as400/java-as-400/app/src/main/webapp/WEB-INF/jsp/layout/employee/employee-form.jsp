...
<form method="post" action="${pageContext.request.contextPath}/employees" class="employee-form">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select id="edLevel" name="edLevel">
                    ...
                    <option value="16" ${(employee.EDLEVEL == '16' || (formData.edLevel != null && formData.edLevel[0] == '16')) ? 'selected' : ''}>16 - High School</option>
                    <option value="17" ${(employee.EDLEVEL == '17' || (formData.edLevel != null && formData.edLevel[0] == '17')) ? 'selected' : ''}>17 - Some College</option>
                    <option value="18" ${(employee.EDLEVEL == '18' || (formData.edLevel != null && formData.edLevel[0] == '18')) ? 'selected' : ''}>18 - Bachelor's Degree</option>
                    <option value="19" ${(employee.EDLEVEL == '19' || (formData.edLevel != null && formData.edLevel[0] == '19')) ? 'selected' : ''}>19 - Master's Degree</option>
                    <option value="20" ${(employee.EDLEVEL == '20' || (formData.edLevel != null && formData.edLevel[0] == '20')) ? 'selected' : ''}>20 - PhD/Doctorate</option>
                </select>
            </div>
        </div>
    </div>
